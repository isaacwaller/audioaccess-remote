...
var rooms = [{ id: 1, name: "Living Room" }, { id: 2, name: "Kitchen" }, { id: 3, name: "Master Bedroom" }, { id: 4, name: "Stella's Room" }, { id: 5, name: "Joe's Room" }];
var roomsdisplay = null;
function renderDisplay() {
  roomsdisplay = ReactDOM.render(React.createElement(RoomsDisplay, { rooms: rooms,
...
},{"./roomsdisplay":3,"async":4,"browser-request":5,"fastclick":6,"react":164,"react-dom":35}],2:[function(require,module,exports){
"use strict";

var React = require('react');

var RoomKeypad = React.createClass({
  displayName: "RoomKeypad",
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "room-back", onClick: this.props.onBack },
      ...
      React.createElement(
        "div",
        { className: "room-sources" },
        React.createElement(
          "div",
          { className: "room-source", "data-active": source == "off", onClick: this.sourceSelected("off") },
          "Off"
        ),
        React.createElement(
          "div",
          { className: "room-source", "data-active": source == "tuner", onClick: this.sourceSelected("tuner") },
          "FM Radio"
        ),
        React.createElement(
          "div",
          { className: "room-source", "data-active": source == "cd", onClick: this.sourceSelected("cd") },
          "CD"
        ),
        React.createElement(
          "div",
          { className: "room-source", "data-active": source == "tape", onClick: this.sourceSelected("tape") },
          "AirPlay"
        ),
        React.createElement(
          "div",
          { className: "room-source", "data-active": source == "video", onClick: this.sourceSelected("video") },
          "Google Cast"
        )
      ),
      React.createElement("input", { type: "range", min: "0", max: "150", step: "5", defaultValue: volume, onInput: this.volumeChange, disabled: source == "off" })
    );
  },

  sourceSelected: function sourceSelected(source) {
    var self = this;
  ...
  volumeChange: function volumeChange(event) {
...
var RoomsDisplay = React.createClass({
  ...
  render: function render() {
    ...
    if (this.state.withKeypad) {
      if (this.state.withKeypad == -1) {
        // Control all rooms
        sidebar = React.createElement(RoomKeypad, { controlAll: true,
        ...
        sidebar = React.createElement(RoomKeypad, { room: this.props.rooms[this.state.withKeypad - 1],
          onBack: this.dismissKeypad,
      ...
      sidebar = React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'sidebar-all', onClick: function () {
              this.showKeypad(-1);
            }.bind(this) },
          'Control All'
        ),
        this.props.rooms.map(function (room) {
          ...
          if (room.source == "video") {
            icon = React.createElement('div', { className: 'sidebar-room-icon icon-google-cast' });
          } else if (room.source == "tape") {
            icon = React.createElement('div', { className: 'sidebar-room-icon icon-airplay' });
          }
          return React.createElement(
            'div',
            { className: clazz, key: room.id, onClick: function () {
                this.showKeypad(room.id);
              }.bind(this) },
            icon,
            React.createElement(
              'h3',
    ...
    return React.createElement(
      'div',
      null,
      React.createElement('div', { className: 'col-sm-8 map' }),
      React.createElement(
        'div',
  ...
  showKeypad: function showKeypad(room) {
...
},{"./roomkeypad":2,"react":164}],4:[function(require,module,exports){
